...
const Enzymes: React.FC = () => {
  const [isModalVisible, setIsModalVisible] = useState(false);

  const columns: ColumnsType<EnzymeItem> = [
    {
      title: 'Name',
      dataIndex: 'name',
      key: 'name',
  ...
  return (
    <div className="enzymes-page">
      <Card title="Enzymes Inventory">
